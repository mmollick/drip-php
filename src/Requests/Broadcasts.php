...
trait Broadcasts
{
     ...
     */
    public function getBroadcasts($options = [])
    {
        return $this->client->accountRequest('GET', 'broadcasts', $options);
    }
    ...
    {
        return $this->client->accountRequest('GET', 'broadcasts/' . $broadcast_id);
    }
}
