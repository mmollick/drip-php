...
trait Conversions
{
     ...
     */
    public function getConversions($options = [])
    {
        return $this->client->accountRequest('GET', 'goals', $options);
    }
     ...
     * @throws ValidationException
     */
    public function getConversion($conversion_id)
    {
        return $this->client->accountRequest('GET', 'goals/' . $conversion_id);
    }
}
